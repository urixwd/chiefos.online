  ...
  return (
    <>
      <motion.div
        ...
        className="min-h-screen flex items-center justify-center bg-[url('https://f003.backblazeb2.com/file/chiefos-website/background.png')] bg-cover bg-center bg-no-repeat relative text-white px-4"
      >
